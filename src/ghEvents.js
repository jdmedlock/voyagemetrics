...
const ghEvents = [
  ...
  { event: 'DownloadEvent', title: 'Download (Deprecated)', deprecated: true, weight: ACTIVITY_PASSIVE },
  { event: 'FollowEvent', title: 'Followed (Deprecated)', deprecated: true, weight: ACTIVITY_PASSIVE },
  { event: 'ForkEvent', title: 'Fork Repo', deprecated: false, weight: ACTIVITY_PASSIVE },
  { event: 'ForkApplyEvent', title: 'Fork Apply (Deprecated)', deprecated: true, weight: ACTIVITY_PASSIVE },
  { event: 'GistEvent', title: 'Gist (Deprecated)', deprecated: true, weight: ACTIVITY_PASSIVE },
